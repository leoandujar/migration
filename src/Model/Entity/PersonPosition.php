...
#[ORM\Table(name: 'person_position')]
#[ORM\UniqueConstraint(name: 'person_position_name_key', columns: ['name'])]
#[ORM\Entity]
class PersonPosition implements EntityInterface
{
	#[ORM\Id]
	#[ORM\GeneratedValue(strategy: 'SEQUENCE')]
	#[SequenceGenerator(sequenceName: 'person_position_id_sequence', initialValue: 1)]
	#[ORM\Column(name: 'person_position_id', type: 'bigint')]
	private string $id;
